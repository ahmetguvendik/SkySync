...
namespace SkySync.Services.Flight.Persistence.Services;

/// <summary>
/// Inbox – Flight servisi. Koltuk rezervasyonu / serbest bırakma duplicate önleme.
/// ReserveSeat, ReleaseSeat consumer'ları MarkAsProcessedAsync kullanır.
/// </summary>
public class InboxService : IInboxService
{
    ...
    public InboxService(FlightServiceDbContext context, ILogger<InboxService> logger)
    {
        _context = context;
        _logger = logger;
    }
